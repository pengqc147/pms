...
<form name="form2"  id="form2" action="${pageContext.request.contextPath}/baoxiao/saveInfo" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<%--<input type="" size="52" name="bxtime"/>--%>
		<input id="bxtime" type="text" name="bxtime"/>
		<img onclick="WdatePicker({el:'bxtime','skin':'YcloudRed'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
