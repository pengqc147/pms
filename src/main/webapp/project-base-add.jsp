...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        $(function(){
			...
			$.ajax({
				type:"GET",
				url:"${pageContext.request.contextPath}/cust/cname",
            ...
            $.ajax({
                type:"GET",
                url:"${pageContext.request.contextPath}/emp/enames",
                success:function(msg){
                    $(msg).each(function(index,item){
...
<form name="form2" id="forms" action="${pageContext.request.contextPath}/pro/postInfo" method="POST">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text" name="comper" id="leader" readonly="readonly" />
	</td>
	<td align="right" bgcolor="#FAFAF1" height="22">项目经理：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="empFk" id="managers">
			<option>请选择...</option>
		</select>
	</td>
</tr>
