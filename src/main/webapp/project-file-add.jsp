...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/atta/getInfo" enctype="multipart/form-data" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="myProjects" name="proFk">
			<option>请选择...</option>
		</select>
	</td>
</tr>
