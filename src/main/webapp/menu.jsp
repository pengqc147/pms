...
<li><a href='${pageContext.request.contextPath}/atta/list' target='main'>附件管理</a> </li>
</ul>
</dd>
</dl>
...
<li><a href='${pageContext.request.contextPath}/baoxiao/list' target='main'>我的报销</a> </li>
<li><a href='${pageContext.request.contextPath}/fatie.jsp' target='main'>我的帖子</a> </li>
<%--<li><a href='message-give.jsp' target='main'>消息推送</a> </li>
--%>
</ul></dd></dl>
