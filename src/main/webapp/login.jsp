												...
												<TBODY>
													<TR>
														...
														<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
															size=16 name="username" id=username value="${sessionScope.loginUser.username}"></TD>
													</TR>
													<TR>
														<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
																码：</FONT></TD>
														<TD><INPUT class=regtxt title=请填写密码 type=password
															maxLength=16 size=16 name="password" id=pass value="${sessionScope.loginUser.password}" ></TD>
													</TR>
													<TR>
														<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
														<TD><INPUT class=regtxt title=请填写验证码 maxLength=16 style="float:left;width: 60px;margin-left: 27px"
															size=16 value="" name="code"> <INPUT type=hidden
															value=check name=login>

															<img id="image" style="float: left;margin-left: 10px" src="${pageContext.request.contextPath}/code/getCode?time="<%=new Date()%>>
														</TD>
													</TR>
