...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
        <%--<input name="comname" value="${project.comname}"/>--%>
		<select name="comname" id="cuscompany" onchange="parseLeader(this.value)">
			<option>请选择...</option>
			<c:forEach items="${cusList}" var="customer">
				<option value="${customer.id}" <c:if test="${project.comname == customer.id}">selected</c:if>>${customer.comname}</option>
			</c:forEach>
		</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<%--<input name="comper" value="${project.comper}"/>--%>
		<input type="text" name="comper" value="${project.comper}" id="leader" readonly="readonly" />
	</td>
	<td align="right" bgcolor="#FAFAF1" height="22">项目经理：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<%--<input name="empFk" value="${project.empFk}"/>--%>
		<select name="empFk" id="empFk">
			<option>请选择...</option>
				<c:forEach items="${empList}" var="employee">
					<c:if test="${employee.pFk==4}">
						<option value="${employee.eid}" <c:if test="${project.empFk == employee.eid}">selected</c:if>>
								${employee.ename}
						</option>
					</c:if>
				</c:forEach>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="endtime" value="<fmt:formatDate value="${project.endtime}"  pattern="yyyy-MM-dd"></fmt:formatDate>"/>
	</td>
</tr>
...
<tr >
	...
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=15 cols=130 name="remark">
			${project.remark}
		</textarea>
	</td>
</tr>
